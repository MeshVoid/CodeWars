...
def is_square(n):
    if n >= 0:
        return n == math.isqrt(n) ** 2 # I'll be honest I've looked up for isqrt() methof in math lib in stachexchange, lol
    else: return False


# The best solution from codewars without using any math library:
